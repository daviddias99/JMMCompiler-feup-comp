...
public class ParseException extends Exception {
	...
	public ParseException(String message, int errorCount) {
		super('\n' + message);
		this.errorCount = errorCount;
	}

	public ParseException(ParseException ex, String message, int errorCount) {
		this(message + '\n' + ex, errorCount);
	}
...
/*
 * JavaCC - OriginalChecksum=48d898a94cd0ac284bcb606323ed1990 (do not edit this
 * line)
 */
