...
## EXECUTE:
It can be run using a command with the following notation:
...
## TASK DISTRIBUTION
The development of the project was done in a collaborative manner using platforms such as Discord and VSCode live share. Although the code was developed by individually or in a pair-programming environment, the discussion about the used algorithms, data-structures and architecture was made by all elements of the group.
