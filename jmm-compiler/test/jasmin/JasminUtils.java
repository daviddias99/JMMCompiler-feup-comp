...
public class JasminUtils {
    ...
    public static String testJmm(String jmmResource, String expectedOutput, List<String> fileDependencies) {	
		return testJmm(jmmResource, expectedOutput);
	}
	
	    public static String testJmm(String jmmResource, String expectedOutput, String stdin, List<String> fileDependencies) {	
		return testJmm(jmmResource, expectedOutput, stdin);
	}
